...
import Notif from './Notifications.jsx'

function App() {
  return (
    <>
    <div className='root-notifications'><Notif /></div>
      ...
      <div className='App-footer'><p>Copyright {getCurrentYear()} - {getFooterCopy(false)}</p></div>
    </>
  )
}
